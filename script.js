...
setTimeout(loadVisitorInfo, 4000);
...
function enterSite() {
  ...
  if (visitorSnapshot) sendWebhook(visitorSnapshot);
  else scheduleWebhookRetry();

  showMain();
}

function showMain() {
  if (mainShown || window.__skidMainDone) return;
  mainShown = true;
...
introCross?.addEventListener("click", () => {
